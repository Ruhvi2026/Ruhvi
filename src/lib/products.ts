...
export const INITIAL_CATEGORIES: Category[] = [
  ...
  { id: 'cat-3', name: 'Earrings', slug: 'earrings' },
  { id: 'cat-4', name: 'Bracelets', slug: 'bracelets' },
  { id: 'cat-5', name: 'Bangles', slug: 'bangles' },
  { id: 'cat-6', name: 'Pendants', slug: 'pendants' },
  { id: 'cat-7', name: 'Chains', slug: 'chains' },
  { id: 'cat-8', name: 'Anklets', slug: 'anklets' },
  { id: 'cat-9', name: 'Nose Pins', slug: 'nose-pins' },
  { id: 'cat-10', name: 'Mangalsutra', slug: 'mangalsutra' },
  { id: 'cat-11', name: 'Bridal Jewellery', slug: 'bridal' },
  { id: 'cat-12', name: "Men's Jewellery", slug: 'mens' },
  { id: 'cat-13', name: "Kids' Jewellery", slug: 'kids' },
];
...
export const DEMO_PRODUCTS: Product[] = [
  {
    ...
    description: 'An exquisite 18K Yellow Gold Solitaire Ring crafted with precision, featuring a brilliant VVS diamond centerpiece that radiates timeless elegance.',
    category_id: 'cat-1',
    price: 49999,
    mrp: 59999,
    gst_rate: 3.0,
  ...
  },
  {
    ...
    description: 'A regal Kundan and Zambian Emerald choker, hand-set in 22K Hallmarked Gold. Designed for grand celebrations and bridal elegance.',
    category_id: 'cat-2',
    price: 189999,
    mrp: 219999,
    gst_rate: 3.0,
  ...
  },
  {
    ...
    description: 'Freshwater cultured pearls suspended from delicate diamond-studded 18K rose gold studs. Graceful, light, and stunning.',
    category_id: 'cat-3',
    price: 24999,
    mrp: 29999,
    gst_rate: 3.0,
  ...
  },
  {
    ...
    description: 'Sleek black bead chain with a brilliant curved diamond pendant in 18K Yellow Gold. Designed for daily comfort and timeless grace.',
    category_id: 'cat-10',
    price: 38999,
    mrp: 44999,
    gst_rate: 3.0,
  ...
  },
  {
    ...
    description: 'A vivid Burmese Ruby wrapped in diamond-paved lotus petals. Crafted in 18K White Gold.',
    category_id: 'cat-6',
    price: 29999,
    mrp: 34999,
    gst_rate: 3.0,
