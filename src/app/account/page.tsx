          ...
          <div className="flex flex-col justify-between space-y-6 rounded-2xl border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-xs">
                <div className="space-y-2 rounded-xl border border-stone-200/70 bg-stone-50 p-4">
                  ...
                  <p className="text-[11px] leading-relaxed text-stone-500">
                    Your account uses encrypted email authentication managed via
                    Supabase.
                  </p>
                </div>

                <div className="space-y-1.5 rounded-xl border border-gold-200/60 bg-gold-50/50 p-4">
